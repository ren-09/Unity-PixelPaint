...
public class NewGameSceneController : MonoBehaviour
{
    ...
    void LevelChange()
    {
        ...
        mainCamera.transform.position = transform.position = new Vector3(-8f, c_pos.y, c_pos.z);
        Invoke("LateCameraSlideIn", 0.5f);
    }

    void LateCameraSlideIn()
    {
        mainCamera.gameObject.AddComponent<CameraSlideIn>();
    }
